...
def predict():
    ...
    pil_image = Image.fromarray(binary_prediction[0, :, :, 0] * 255)
    
    # Save the image temporarily
    temp_img_path = os.path.join('./', 'prediction_temp.jpg')
    pil_image.save(temp_img_path)
    
    # Send back the image file path or base64 encoded image
